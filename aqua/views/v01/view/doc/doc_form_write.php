...
<div class="content-page" >
    ...
    <div class="content">
        <div class="container">
            ...
            <form class="form-horizontal" role="form" method="post" id="form_write" enctype="multipart/form-data"  action="./doc_form_proc" >                
                <input type="hidden" name="mode" id="mode" value="<?=$mode?>" />
                <input type="hidden" name="doc_type" value="<?=$doc_type?>" />                
                <input type="hidden" name="doc_idx" id="doc_idx" value="<?=$doc_idx?>" />
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" >                                            
                                            ...
                                            <select class="form-control" name="item_code" style="width:200px" >
                                                <?php
                                                    foreach( $doc_items AS $key=>$val ) {
                                                ?>
                                                <option value="<?=$val['item_code']?>" <?=($item_code == $val['item_code'] ? 'selected="selected"' : '' )?> ><?=$val['title']?></option> 
                                                <?php
                                                    }
                                                ?>
                                            </select>
...
<link rel="stylesheet" type="text/css" href="<?=$aqua_view_path;?>/public/css/imasic.doc.css" />
...
<script type="text/javascript" src="<?=$aqua_view_path;?>/public/js/imasic.doc.2.0.0.js"></script>
<script type="text/javascript" src="<?=$aqua_view_path;?>/public/js/imasic.doc.editor.js"></script>
...
<script>
    ...
    if( $('#mode').val() == 'ins' ) {
        ...
        imasicAdminEditor.init({
            target_id : 'table_create_area'            
            , return_data_id : 'doc_data'            
            , set_head : true
