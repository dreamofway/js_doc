                            ...
                            <form class="form-horizontal group-border-dashed clearfix" name="fsearch" id="fsearch" method="get" action="">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" name="sch_keyword" value="<?=$sch_keyword;?>" placeholder="문서명">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                            ...
                            <table class="table table-bordered text-center" id="excelTable">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
											<a class="underline" href="./<?=$page_name?>_write?mode=edit&page=<?=$page?><?=$params?>&doc_idx=<?=$value['doc_idx'];?>">
                                                <?=$value['doc_title'];?>
											</a>
										</td>                                        
                                        <td><?=number_format( $value['use_cnt'] )?></td>
